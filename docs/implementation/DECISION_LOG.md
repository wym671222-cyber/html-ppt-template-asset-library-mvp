...
当前 G2 状态：`approved`。用户于 2026-08-10T10:06:13+08:00 明确回复“批准提交 `8d125d2d9afb213f449dbdc2d32c4939f5407441` 推送并部署到 `ppt.ajjy-ai.site`”。该审批仅授权 P17 计划内的精确 SHA push、生产 preflight、备份、迁移、原子切换、管理员初始化和验收；不授权 force push、删除旧 release/PM2/备份或输出凭据。
